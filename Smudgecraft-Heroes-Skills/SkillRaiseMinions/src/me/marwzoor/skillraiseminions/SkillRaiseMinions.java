package me.marwzoor.skillraiseminions;
...
public class SkillRaiseMinions extends ActiveSkill
{
	public static SkillRaiseMinions skill;	
	
	public SkillRaiseMinions(Heroes instance)
	{
	...
	public class RaiseMinionsEffect extends ExpirableEffect
	{
		List<Companion> zombies = new ArrayList<Companion>();
		public RaiseMinionsEffect(Skill skill, long duration, List<Companion> zombies)
		{
			super(skill, "RaiseMinions", duration);
		...
		{
			boolean check = false;;
			Iterator<Companion> itr = zombies.iterator();
			while(itr.hasNext())
			{
